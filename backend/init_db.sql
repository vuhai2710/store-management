...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Bảng lưu thông báo cho users';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `final_amount` decimal(15,2) GENERATED ALWAYS AS (greatest((ifnull(`total_amount`,0) - ifnull(`discount`,0)),0)) STORED COMMENT 'Tổng tiền cuối (>=0)',
  `notes` text,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Dump completed on 2025-11-11 20:32:47
