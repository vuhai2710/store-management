...
public class InventoryTransactionController {
        ...
        public ResponseEntity<ApiResponse<PageResponse<InventoryTransactionDTO>>> getAllTransactions(
                ...
                PageResponse<InventoryTransactionDTO> transactions = inventoryTransactionService
        ...
        public ResponseEntity<ApiResponse<PageResponse<InventoryTransactionDTO>>> getTransactionsByProduct(
                ...
                return ResponseEntity.ok(
                                ApiResponse.success("Lấy lịch sử nhập/xuất kho của sản phẩm thành công", transactions));
        }
        ...
        public ResponseEntity<ApiResponse<PageResponse<InventoryTransactionDTO>>> getTransactionsByReference(
                ...
                PageResponse<InventoryTransactionDTO> transactions = inventoryTransactionService
                                .getTransactionsByReference(referenceType, referenceId, pageable);
                return ResponseEntity.ok(ApiResponse.success("Lấy lịch sử nhập/xuất kho theo reference thành công",
                                transactions));
        }
        ...
        public ResponseEntity<ApiResponse<PageResponse<InventoryTransactionDTO>>> getTransactionsByType(
                ...
                PageResponse<InventoryTransactionDTO> transactions = inventoryTransactionService
                                .getTransactionsByType(transactionType, pageable);
                return ResponseEntity.ok(ApiResponse.success("Lấy lịch sử " +
                                (transactionType == TransactionType.IN ? "nhập kho" : "xuất kho") + " thành công",
                                transactions));
        }
        ...
        public ResponseEntity<ApiResponse<PageResponse<InventoryTransactionDTO>>> filterTransactions(
                ...
                PageResponse<InventoryTransactionDTO> transactions = inventoryTransactionService
                                .getTransactionsByMultipleCriteria(
        ...
        public ResponseEntity<ApiResponse<PageResponse<InventoryTransactionDTO>>> filterTransactionsAdvanced(
                ...
                PageResponse<InventoryTransactionDTO> transactions = inventoryTransactionService
                                .getTransactionsByAdvancedCriteria(
                                                transactionType, referenceType, productId, productName, sku, start, end,
                                                pageable);
        ...
        public ResponseEntity<ApiResponse<PageResponse<InventoryTransactionDTO>>> searchTransactions(
                ...
                PageResponse<InventoryTransactionDTO> transactions = inventoryTransactionService.filterTransactions(
                                transactionType, referenceType, referenceId, productId, productName, sku, brand, start,
                                end, pageable);

                return ResponseEntity
                                .ok(ApiResponse.success("Tìm kiếm lịch sử nhập/xuất kho thành công", transactions));
        }
}
