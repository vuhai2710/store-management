...
const ReturnItemCard = ({
  ...
  const productName = item.productNameSnapshot || item.productName || item.product?.productName || "Sản phẩm";
      ...
      <div className="flex items-start gap-4">
        ...
        {isSelected && (
          <div className="flex flex-col items-end gap-2">
            <label className="text-sm text-gray-600 font-medium">Số lượng đổi/trả:</label>
