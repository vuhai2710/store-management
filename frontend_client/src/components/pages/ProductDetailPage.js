...
const ProductDetailPage = ({
  ...
  const DescriptionBlock = () => (
    <div
      ...
      <ul
        style={{ listStyle: "disc", paddingLeft: "1.5rem", color: "#495057" }}>
  ...
  const ReviewsBlock = () => (
    <div
      ...
      <p style={{ color: "#6c757d", textAlign: "center" }}>
        No detailed reviews available yet for this product.
      </p>
  ...
  const InformationBlock = () => (
    <div
      ...
      <p style={{ lineHeight: 1.6, color: "#495057", marginBottom: "1.5rem" }}>
        We offer Free Shipping for all orders over $500 worldwide. Delivery time
        usually takes 3-7 business days depending on the region.
      </p>
      <p style={{ lineHeight: 1.6, color: "#495057" }}>
        Returns are accepted within 30 days of receiving your order, provided
              ...
              {[...Array(3)].map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    opacity: i === 0 ? 1 : 0.6,
                    cursor: "pointer",
                    border: i === 0 ? "2px solid #007bff" : "none",
                  }}></div>
              ))}
            </div>
          </div>
                ...
                <button
                  ...
                  <Heart
                    ...
                    style={{
                      ...
                      color: isInWishlist(product.id) ? "red" : "#495057",
                    }}
                  />
